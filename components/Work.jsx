        ...
        <ThisSectionWrapper>
          ...
          <ThisSectionTile5> 
            <Section_Text_Module title="E-commerce QA Lead">
              <p style={{fontStyle: 'italic'}}> Fast-growing lifestyle e-shop (through Amaris Corporation), NYC <br/> July 2016 - October 2016</p>
          ...
          <ThisSectionTile4>
            <Section_Text_Module title="E-commerce Business Analyst">
              <p style={{fontStyle: 'italic'}}> French luxury fragrance brand (through Amaris Corporation), NYC <br/> October 2016 - January 2017</p>
